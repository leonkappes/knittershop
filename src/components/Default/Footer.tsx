...
export default function Footer() {
    return (
        ...
        <div className="flex flex-row justify-evenly gap-4 mb-2">
            <Link href={""} className="text-md text-primary font-serif text-center w-1/3">agb</Link>
            <Link href={""} className="text-md text-primary font-serif text-center w-1/3">impressum</Link>
            <Link href={""} className="text-md text-primary font-serif text-center w-1/3">versand</Link>
        </div>
